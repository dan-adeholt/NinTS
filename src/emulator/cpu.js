...
const opcodes = [
    ...
    [0xE7, "*ISB", ModeZeroPage,    illegal.isb, memory.readZeroPage],
    [0xF7, "*ISB", ModeZeroPageX,   illegal.isb, memory.readZeroPageX],
    [0xEF, "*ISB", ModeAbsolute,    illegal.isb, memory.readAbsolute],
    [0xFF, "*ISB", ModeAbsoluteX,   illegal.isb, memory.readAbsoluteX],
    [0xFB, "*ISB", ModeAbsoluteY,   illegal.isb, memory.readAbsoluteY],
    [0xE3, "*ISB", ModeIndirectX,   illegal.isb, memory.readIndirectX],
    [0xF3, "*ISB", ModeIndirectY,   illegal.isb, memory.readIndirectY],
