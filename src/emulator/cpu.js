...
import * as instructions from './instructions/util';
...
const opcodes = [
    [0x0B, "*AAC", ModeImmediate,   arithmetic.aac, memory.readImmediate],
    [0x2B, "*AAC", ModeImmediate,   arithmetic.aac, memory.readImmediate],
    ...
    [0x6B, "*ARR", ModeImmediate,   arithmetic.arr, memory.readImmediate],
    ...
    [0xE7, "*ISB", ModeZeroPage,    arithmetic.isb, memory.readZeroPage],
    [0xF7, "*ISB", ModeZeroPageX,   arithmetic.isb, memory.readZeroPageX],
    [0xEF, "*ISB", ModeAbsolute,    arithmetic.isb, memory.readAbsolute],
    [0xFF, "*ISB", ModeAbsoluteX,   arithmetic.isb, memory.readAbsoluteX],
    [0xFB, "*ISB", ModeAbsoluteY,   arithmetic.isb, memory.readAbsoluteY],
    [0xE3, "*ISB", ModeIndirectX,   arithmetic.isb, memory.readIndirectX],
    [0xF3, "*ISB", ModeIndirectY,   arithmetic.isb, memory.readIndirectY],
    ...
    [0x07, "*SLO", ModeZeroPage,    arithmetic.slo, memory.readZeroPage],
    [0x17, "*SLO", ModeZeroPageX,   arithmetic.slo, memory.readZeroPageX],
    [0x0F, "*SLO", ModeAbsolute,    arithmetic.slo, memory.readAbsolute],
    [0x1F, "*SLO", ModeAbsoluteX,   arithmetic.slo, memory.readAbsoluteX],
    [0x1B, "*SLO", ModeAbsoluteY,   arithmetic.slo, memory.readAbsoluteY],
    [0x03, "*SLO", ModeIndirectX,   arithmetic.slo, memory.readIndirectX],
    [0x13, "*SLO", ModeIndirectY,   arithmetic.slo, memory.readIndirectY],
    [0xAB, "*ATX", ModeImmediate,   arithmetic.atx, memory.readImmediate],
    [0xCB, "AXS",  ModeImmediate,   arithmetic.axs, memory.readImmediate],
    ...
    [0xC7, "*DCP", ModeZeroPage,    compare.dcp, memory.readZeroPage],
    [0xD7, "*DCP", ModeZeroPageX,   compare.dcp, memory.readZeroPageX],
    [0xCF, "*DCP", ModeAbsolute,    compare.dcp, memory.readAbsolute],
    [0xDF, "*DCP", ModeAbsoluteX,   compare.dcp, memory.readAbsoluteX],
    [0xDB, "*DCP", ModeAbsoluteY,   compare.dcp, memory.readAbsoluteY],
    [0xC3, "*DCP", ModeIndirectX,   compare.dcp, memory.readIndirectX],
    [0xD3, "*DCP", ModeIndirectY,   compare.dcp, memory.readIndirectY],
    ...
    [0x4B, "*ASR", ModeImmediate,   readmodifywrite.asr, memory.readImmediate],
    ...
    [0x27, "*RLA", ModeZeroPage,    readmodifywrite.rla, memory.readZeroPage],
    [0x37, "*RLA", ModeZeroPageX,   readmodifywrite.rla, memory.readZeroPageX],
    [0x2F, "*RLA", ModeAbsolute,    readmodifywrite.rla, memory.readAbsolute],
    [0x3F, "*RLA", ModeAbsoluteX,   readmodifywrite.rla, memory.readAbsoluteX],
    [0x3B, "*RLA", ModeAbsoluteY,   readmodifywrite.rla, memory.readAbsoluteY],
    [0x23, "*RLA", ModeIndirectX,   readmodifywrite.rla, memory.readIndirectX],
    [0x33, "*RLA", ModeIndirectY,   readmodifywrite.rla, memory.readIndirectY],
    ...
    [0x67, "*RRA", ModeZeroPage,    readmodifywrite.rra, memory.readZeroPage],
    [0x77, "*RRA", ModeZeroPageX,   readmodifywrite.rra, memory.readZeroPageX],
    [0x6F, "*RRA", ModeAbsolute,    readmodifywrite.rra, memory.readAbsolute],
    [0x7F, "*RRA", ModeAbsoluteX,   readmodifywrite.rra, memory.readAbsoluteX],
    [0x7B, "*RRA", ModeAbsoluteY,   readmodifywrite.rra, memory.readAbsoluteY],
    [0x63, "*RRA", ModeIndirectX,   readmodifywrite.rra, memory.readIndirectX],
    [0x73, "*RRA", ModeIndirectY,   readmodifywrite.rra, memory.readIndirectY],

    [0x87, "*SAX", ModeZeroPage,    store.sax, memory.readZeroPage],
    [0x97, "*SAX", ModeZeroPageY,   store.sax, memory.readZeroPageY],
    [0x83, "*SAX", ModeIndirectX,   store.sax, memory.readIndirectX],
    [0x8F, "*SAX", ModeAbsolute,    store.sax, memory.readAbsolute],
    [0x47, "*SRE", ModeZeroPage,    store.sre, memory.readZeroPage],
    [0x57, "*SRE", ModeZeroPageX,   store.sre, memory.readZeroPageX],
    [0x4F, "*SRE", ModeAbsolute,    store.sre, memory.readAbsolute],
    [0x5F, "*SRE", ModeAbsoluteX,   store.sre, memory.readAbsoluteX],
    [0x5B, "*SRE", ModeAbsoluteY,   store.sre, memory.readAbsoluteY],
    [0x43, "*SRE", ModeIndirectX,   store.sre, memory.readIndirectX],
    [0x53, "*SRE", ModeIndirectY,   store.sre, memory.readIndirectY],
    ...
    [0x9E, "*SXA", ModeAbsoluteY,   store.sxa],
    [0x9C, "*SYA", ModeAbsoluteX,   store.sya],
